...
ct_asset_file_path = r'C:\Users\vcosi.tvc3287\Desktop\New_folder\CT_Assest\13mn_Modified2x2_3rdMar_24.xlsb'  #change the name of the ct file
sheet = '13Mn DCR'
...
filter_ct_asset_df = ct_asset_file[ct_asset_file['Final Asset Mapping'] == 'Fintech'].copy()
selected_columns = ['incidentId', 'queue', 'status', 'orderId', 'accountId', 'subSubIssue', 'Created_At', 'Added2Queue', 'Overall Priority', 'Final Asset Mapping','13M X 40K Influencers File.Column2']
