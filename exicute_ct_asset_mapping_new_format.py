...
ct_asset_file_path = r'C:\Users\vcosi.tvc3287\Desktop\New_folde r\CT_Assest\13mn Modified 2x2_new Format_10th March.xlsb'  #change the name of the ct file
sheet = '13Mn DCR'
ct_asset_file = pd.read_excel(ct_asset_file_path, engine='pyxlsb', sheet_name=sheet)


# Apply the filter to get the fintech incidents
print("Reading the fintech incident.......")
desired_categories = ['Paylater / Billing issuse', 'Re-Con issues', 'Recharge Related Issues', 'Account Closure Issues']
filter_ct_asset_df = ct_asset_file[ct_asset_file['Problem Statement'].isin(desired_categories)].copy()
selected_columns = ['incidentId', 'queue', 'status', 'orderId', 'accountId', 'subSubIssue', 'Created_At', 'Added2Queue', 'Q2R Bucket','13M X 40K Influencers File.Column2']
...
fintech_filename = fr"C:\Users\vcosi.tvc3287\Desktop\New_folder\CT_Assest\fintech_ct_asset_{today_date}.xlsx"
...
response_excel_path = r"C:\Users\vcosi.tvc3287\Desktop\New_folder\CT_Assest\Response-BNPL_Tech_Escalation_Form.xlsx"
...
fintech_L3_scr_df_path = r'C:\Users\vcosi.tvc3287\Desktop\New_folder\CT_Assest\Fintech_L3_Form_Responses.xlsx'
...
# Convert 'Escalated Date' to datetime, coerce errors to NaT
fintech_L3_scr_df['Escalated Date'] = pd.to_datetime(fintech_L3_scr_df['Escalated Date'], errors='coerce')
...
fintech_IDFC_Esc_df_path = r'C:\Users\vcosi.tvc3287\Desktop\New_folder\CT_Assest\Response_IDFC_Esclation_Form.xlsx'
...
# Operating with Response_Fintech_L2_Handle_Form.xlsx ----- https://docs.google.com/spreadsheets/d/1PRSpLCNVqvCPDxFHBtZDjucYvHW1xWn-AwmWUrDabC0/edit#gid=0
fintech_L2_handle_df_path = r'C:\Users\vcosi.tvc3287\Desktop\New_folder\CT_Assest\Response_Fintech_L2_Handle_Form.xlsx'
...
fintech_L3_handle_df_path = r'C:\Users\vcosi.tvc3287\Desktop\New_folder\CT_Assest\Resposne_Fintech_L3_Handle_Form.xlsx'
