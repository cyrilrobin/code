...
ct_asset_file_path = r'FintechAssetMapping\13mn_Modified_2x2_new_Format_10th_April.xlsb'  #change the name of the ct file
sheet = '13Mn DCR'
...
filter_ct_asset_df = ct_asset_file[(ct_asset_file['Asset'] == 'Fintech / Payments') & (ct_asset_file['Senti'] != 'RESOLVED')].copy()
selected_columns = ['incidentId', 'queue', 'status', 'orderId', 'accountId', 'issue','subIssue','subSubIssue', 'Created_At', 'Added2Queue', 'LOB','13M X 40K Influencers File.Column2','Problem Statement','Asset','Senti']
...
fintech_L3_scr_df_path = r'FintechAssetMapping/Fintech_L3_Form_Responses.csv'
